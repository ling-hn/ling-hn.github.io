...
skills:
  - name: Technical Skills
    items: |
      - name: Python, Fortran, Basic SQL
        description: |
        - Libraries: Numpy, Pandas, Matplotlib, Seaborn, SciPy
        - Machine Learning: TensorFlow, PyTorch
        - Version Control and Collaborative: GitHub, Jupyter Notebooks
        percent: ''
        icon: code-bracket
      - name: Data Science
        description: |
        ...
        percent: ''
        icon: chart-bar
      - name: Parallel & Accelerated Computing
        description: |
        - GPU-accelerated program optimization (HOOMD)
        - Parallel computing in large-scale simulations (MPI, OpenMP)
        percent: ''
        icon: circle-stack
      - name: Operating System and Office Software
        description: |
        - Windows, Linux
...
I am a PhD in Chemical Engineering with expertise in computational modeling for soft matter physics. Also enthusiastic in Data Science and Machine Learning through self-learning.
